...
JAVA_BUILD=linux-x86_64-server-release
JAVA_17=$HOME/.sdkman/candidates/java/17.0.2-open/bin/java
...
TEST_SUITE_RES=$HOME/results/java-test-suite
...
$JAVA_17 -jar $JACOCO/lib/jacococli.jar report jacoco.exec \
	...
	--html javac-test-suite --csv java-test-suite.csv
